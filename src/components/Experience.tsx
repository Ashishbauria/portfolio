  ...
  return (
    ...
    >
      ...
      <div className="p-0 md:px-8">
        ...
        <p className="font-bold text-xl sm:text-2xl text-center sm:mt-2">FuelCab India</p>
        ...
        <ul className=" list-disc space-y-3 ml-5 text-sm md:text-[16px] text-left font-poppins">
          <li>
            Developed and maintained FuelCab India's website using HTML, CSS,
            and JavaScript, ensuring that it was mobile responsive and
